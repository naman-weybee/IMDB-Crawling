...
namespace Phillips_Crawling_Task.Service
{
    public class XpathStrings
    {
        ...
        public static readonly string MoviePosterImageUrlXpath = ".//div[@class='ipc-media ipc-media--poster-27x40 ipc-image-media-ratio--poster-27x40 ipc-media--baseAlt ipc-media--poster-l ipc-poster__poster-image ipc-media__img']";
        ...
        public static readonly string MovieDirectorXpath = ".//button[.='Director']/following-sibling::div/ul/li[@class='ipc-inline-list__item']/a[1]";
        public static readonly string MovieWritersXpath = ".(//a[.='Writers']/following-sibling::div/ul)[1]/li";
        public static readonly string MovieStarsXpath = ".(//a[.='Stars']/following-sibling::div/ul)[1]/li";
